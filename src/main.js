...
const tripHeaderControls = tripHeader.querySelector(`.trip-controls`);
const tripHeaderCaptions = tripHeaderControls.querySelectorAll(`.trip-controls h2`);
...
const createEventWithDestination = () => {
  return (
